...
<body>
    <h2>CRUD Prepared Statements and Properties</h2>

    <ul class="list-group">
        <li class="list-group-item list-group-item-action"><a href="create.jsp">Create</a></li>
        <li class="list-group-item list-group-item-action"><a href="PStatementProps/createPreparedStatement.jsp">Create Prepared Statement</a></li>
